...
@Component({
  ...
  <div class="max-w-5xl mx-auto space-y-6">
    ...
    @if (user) {
      ...
      <!-- RENDEZ-VOUS — UX alignée "Mon compte" -->
              ...
              <div class="p-4 rounded-2xl border border-black/10">
                <div class="flex items-start justify-between gap-3">
                  ...
                  <div class="flex gap-2 shrink-0">
                    ...
                    <!-- Optionnel : action admin si tu as l’endpoint d’annulation côté back -->
                    <!--
                    @if (r.statut !== 'ANNULE' && r.statut !== 'REFUSE') {
                      <button class="btn-ghost h-9 text-red-600" (click)="cancel(r)" [disabled]="cancelingId===r.id">
